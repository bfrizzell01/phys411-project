...
The data was collected by [Johannes Gemmrich](https://web.uvic.ca/~gemmrich/) of the UVic Ocean and Atmospheric Sciences Department. Therefore, data is not made publicly available due to the potential for intellectual property infringement. The code used to perform the analysis, however, is made available [here.](https://github.com/bfrizzell01/phys411-project/tree/main/src)
